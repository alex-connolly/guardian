...
func TestBuiltinRequire(t *testing.T) {
	e := NewVM()
	a, _ := validator.ValidateExpression(e, "require(5 > 3)")
...
func TestBuiltinAssert(t *testing.T) {
	e := NewVM()
	a, _ := validator.ValidateExpression(e, "assert(5 > 3)")
	//goutil.AssertNow(t, errs == nil, errs.Format())
	code := e.traverseExpression(a)
	expected := []string{
		"PUSH1",
...
func TestBuiltinAddmod(t *testing.T) {
	e := NewVM()
	a, _ := validator.ValidateExpression(e, "addmod(1, 2, 3)")
	//goutil.AssertNow(t, errs == nil, errs.Format())
	code := e.traverseExpression(a)
	expected := []string{
		"PUSH1",
...
func TestBuiltinBalance(t *testing.T) {
	e := NewVM()
	a, _ := validator.ValidateExpression(e, "balance(0xFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFF)")
	//goutil.AssertNow(t, errs == nil, errs.Format())
	code := e.traverseExpression(a)
	expected := []string{
		"PUSH1",
...
func TestBuiltinSha3(t *testing.T) {
	e := NewVM()
	a, _ := validator.ValidateExpression(e, `sha3("hello")`)
	//goutil.AssertNow(t, errs == nil, errs.Format())
	code := e.traverseExpression(a)
	expected := []string{
		"PUSH",
